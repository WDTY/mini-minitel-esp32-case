...
for part in ['body', 'cover', 'assembly']:
    p = ROOT / f'archive/v0.4/stl/minitel_{part}_v0.4-review.stl'
    mesh = load_stl(p)
    parts[part] = mesh
    edges = Counter()
    adj = {}
...
rasterize(objects, 'archive/v0.4/renders/front-review.png',
...
rasterize(objects, 'archive/v0.4/renders/rear-review.png',
