...
lid=mesh('archive/v0.3/stl/minitel_lid_v0.3-test.stl',[.89,.82,.69])
keyboard=mesh('archive/v0.3/stl/minitel_keyboard_v0.3-test.stl',[.89,.82,.69])
carrier=mesh('archive/v0.3/stl/minitel_carrier_v0.3-test.stl',[.88,.43,.13])
...
reset=(transform(load_stl(ROOT/'archive/v0.3/stl/minitel_reset_plunger_v0.3-test.stl'),[[0,0,-1],[0,1,0],[1,0,0]],[34.8,11.7,50.3]),np.array([.12,.68,.42]))

OUT='archive/v0.3/renders/'
