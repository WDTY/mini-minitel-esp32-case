...
Usage: python build_pcb_reference.py path/to/Gerber_minitel_esp32_v2.2.zip
...
def extract(path):
    ...
    result+='module pcb_reference(x=10, y=11.95, z=6) { translate([x,y,z]) rotate([90,0,0]) linear_extrude(height=1.6) pcb_reference_2d(); }\n'
    Path(__file__).with_name('pcb_reference.scad').write_text(result)
